...
from slack.models import PinnedMessage, UserStats, CommsChannel
...
def all_doc(request: HttpRequest):

    incidents = Incident.objects.all()
    comms_channel = CommsChannel.objects.all()
    return render(request, template_name='all_doc.html', context={
        "incidents": incidents
    })
